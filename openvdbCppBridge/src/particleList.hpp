...
/**
 * This class is required by openvdb::tools::ParticlesToLevelSet.
 * It is just a wrapper around a vector of particles.
 *
 * @see https://www.openvdb.org/documentation/doxygen/ParticlesToLevelSet_8h.html
 */
class ParticleList {
protected:
    struct Particle {
